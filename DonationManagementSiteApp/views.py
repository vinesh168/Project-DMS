...
def vol_signed_up(request):
    ...
    query1 = "select * from donationmanagementsiteapp_volunteers where email= '" + email + "'"
    ...
    if len(data) > 0:
        ...
        new_volunteer = Volunteers(username=username, phonenumber=phonenumber, email=email, password=password,
                                   aadhar_image_path=aadhar_image_path, address=address)
        new_volunteer.save()
